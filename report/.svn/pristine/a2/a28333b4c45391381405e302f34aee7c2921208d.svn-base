...
<birt:parameterPage
 ...
 <table>
 	<tr>
 		<td style="width:10%"><span>单号</span></td><td><birt:paramDef id="BillNumber" name="BillNumber" cssClass="form-control input-sm"/></td>
 		...
 		<td style="width:10%"><span class="requiredConCus">开始日期</span></td><td style="width:15%"><input id="BuildDate1" type="text" maxlength="20" class="requiredCus form-control input-sm Wdate" pattern="yyyyMMdd"  onclick="WdatePicker({dateFmt:'yyyyMMdd'});" value="20141201"/></td>
