...
<h2 style="text-align:center">水、电、气消耗月报表查询</h2>
<birt:parameterPage
    id="parameterPage"
    name="form1"
    isCustom="true"
    pattern="frameset"
    reportDesign="energy_consumption.rptdesign"
    target="_blank"
    showTitle="false"
    scrolling="no"
    format="html">
 <table>
 	<tr>
 		<td><span class="requiredConCus">年份</span></td><td><birt:paramDef id="month" name="month" cssClass="form-control input-sm"/></td>
 	</tr>
 </table>
</birt:parameterPage>  
