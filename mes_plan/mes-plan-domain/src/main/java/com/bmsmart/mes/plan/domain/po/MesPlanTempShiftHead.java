 ...
 * @version 2017-09-04
 */
public class MesPlanTempShiftHead extends MesDataEntity<MesPlanTempShiftHead> {
	...
	private String technicUser;
	
	private List<String> shiftIdList;//查询条件
	public MesPlanTempShiftHead() {
		super();
	}

	public MesPlanTempShiftHead(String id){
		super(id);
	}
